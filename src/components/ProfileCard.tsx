...
const ProfileCardComponent: React.FC<ProfileCardProps> = ({
  ...
  // Clean transparent glare style on hover
  ...
  return (
    ...
    >
      ...
      <div ref={shellRef} className="relative z-[1] group">
        <section
          className="grid relative overflow-hidden shine-border"
          style={{
            width: '100%',
            aspectRatio: '0.718',
          ...
          >
            ...
            >
              ...
              <div 
                ...
                style={{
                  background: 'linear-gradient(to bottom, rgba(0,0,0,0.5) 0%, rgba(0,0,0,0.1) 25%, rgba(0,0,0,0.2) 60%, rgba(0,0,0,0.85) 100%)',
                }}
              />
                ...
                >
                  ...
                  <div className="flex gap-1.5 flex-shrink-0" style={{ pointerEvents: 'auto', gridArea: 'auto' }}>
                    ...
                    {(!linkedin && !instagram && (!portfolio || portfolio === 'NA' || portfolio === 'na')) && (
                      <button
                        className="border border-primary/60 rounded-lg px-4 py-3 text-xs font-semibold text-primary cursor-pointer backdrop-blur-[10px] transition-all duration-200 ease-out hover:bg-primary/20 hover:-translate-y-px"
